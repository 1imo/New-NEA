...
function Input(props) {
    ...
    return <>
        <section style={styles.overlay}>
            <input onChange={(e) => change(e)} type={props.type} style={props?.type != "file" ? styles.inp : styles.file} className="normInputScreen" placeholder={`${props.placeholder}`} ref={inputRef} />
        
            
            <section style={styles.input}>
                <Slider verify={setVerify} />
                
                <button className="accentBtn" style={styles.second} onClick={() => window.location.href = props.referer} onTouchStart={() => navigate(`${props.referer}`)}>
